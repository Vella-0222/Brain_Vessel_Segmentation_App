classdef hist_parameter < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        setthetragethistogramDropDownLabel  matlab.ui.control.Label
        setthetragethistogramDropDown   matlab.ui.control.DropDown
...
%             app.filename_prefix_EditField.Value="ÿÿÿÿÿÿÿÿÿÿ,ÿÿÿ'filename prefix'";
        ...
        % Value changed function: setthetragethistogramDropDown
        function setthetragethistogramDropDownValueChanged(app, event)
            value = app.setthetragethistogramDropDown.Value;
            switch value
                case 'MIDAS'
                    app.target_hist='Target_Hist.mat';
                case 'TubeTK'%ÿÿÿÿÿÿÿÿÿÿÿÿ
                    app.target_hist='Target_Hist_TubeTK.mat';
                    uialert(app.UIFigure,'The group histogram of the TubeTK is not configured!','Notice','Icon','error') 
                otherwise   
            end
        end
        ...
        function saveallButtonPushed(app, event)
            ...
            switch value
                case 'MIDAS'
                    app.target_hist='Target_Hist.mat';
                case 'TubeTK'%ÿÿÿÿÿÿÿÿÿÿÿÿ
                    app.target_hist=Target_Hist_TubeTK;
                    uialert(app.UIFigure,'The group histogram of the TubeTK is not configured!','Notice','Icon','error') 
                otherwise   
            end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create setthetragethistogramDropDownLabel
            app.setthetragethistogramDropDownLabel = uilabel(app.parametersPanel);
            app.setthetragethistogramDropDownLabel.HorizontalAlignment = 'right';
            app.setthetragethistogramDropDownLabel.Position = [15 33 132 22];
            app.setthetragethistogramDropDownLabel.Text = 'set the traget histogram';

            % Create setthetragethistogramDropDown
            app.setthetragethistogramDropDown = uidropdown(app.parametersPanel);
            app.setthetragethistogramDropDown.Items = {'MIDAS', 'TubeTK', 'Option 3', 'Option 4'};
            app.setthetragethistogramDropDown.ValueChangedFcn = createCallbackFcn(app, @setthetragethistogramDropDownValueChanged, true);
            app.setthetragethistogramDropDown.Position = [162 33 235 22];
            app.setthetragethistogramDropDown.Value = 'MIDAS';
            ...
            app.filename_prefix_EditField.Position = [162 12 235 22];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = hist_parameter(varargin)
